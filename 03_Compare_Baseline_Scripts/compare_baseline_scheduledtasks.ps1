param([string] $BaseLinePath="..\Baseline\Scheduled_Tasks_Baseline.csv")
...
$current = Invoke-Command -UseSSL -SessionOption $so -ComputerName $targets -Credential $creds -FilePath ..\01_Reference_Scripts\ScheduledTask.ps1 
